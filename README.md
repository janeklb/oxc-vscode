...
| `oxc.requireConfig`           | `false`       | `true` \| `false`                                                                                             | Start the language server only when a `.oxlintrc.json(c)` or `oxlint.config.js`, `oxlint.config.ts`, `oxlint.config.mjs`, or `oxlint.config.mts` file exists in one of the workspaces.                                                 |
